...
попытке применить это изменение с другой подсетью возникала ошибка: Error: Error while requesting API to update Subnet: ... rpc error: code = FailedPrecondition desc = CIDR 10.0.2.0/24 has allocated addresses
